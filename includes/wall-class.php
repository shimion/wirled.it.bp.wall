...
class BuddyBoss_Wall_BP_Component extends BP_Component
{
	...
	*/
	...
	public function assets()
	{
		...
		wp_register_style('buddyboss-wall-fontawesome', "//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css", false, null);
		wp_enqueue_style( 'buddyboss-wall-fontawesome' );

		if ( $load_css )
		{
			// Wall stylesheet.
//			wp_enqueue_style( 'buddyboss-wall-main', buddyboss_wall()->assets_url . '/css/buddyboss-wall.css', array(), '1.2.4', 'all' );
			wp_enqueue_style( 'buddyboss-wall-main', buddyboss_wall()->assets_url . '/css/buddyboss-wall.min.css', array(), '1.2.4', 'all' );
		}
...
//        wp_enqueue_script( 'buddyboss-wall-main', buddyboss_wall()->assets_url . '/js/buddyboss-wall.js', array( 'jquery', 'buddyboss-wall-tooltip' ), '1.2.5', true );
        wp_enqueue_script( 'buddyboss-wall-main', buddyboss_wall()->assets_url . '/js/buddyboss-wall.min.js', array( 'jquery', 'buddyboss-wall-tooltip' ), '1.2.5', true );
