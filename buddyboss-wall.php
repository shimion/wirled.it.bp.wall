...
if ( ! defined( 'BUDDYBOSS_WALL_PLUGIN_VERSION' ) ) {
  define( 'BUDDYBOSS_WALL_PLUGIN_VERSION', '1.2' );
}
...
if ( !function_exists( 'register_buddyboss_menu_page' ) ) {
	...
	function register_buddyboss_menu_page() {
		...
		add_menu_page( 'BuddyBoss', 'BuddyBoss', 'manage_options', 'buddyboss-settings', '', buddyboss_wall()->assets_url . '/images/logo.svg', 61.000129 );
